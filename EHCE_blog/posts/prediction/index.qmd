...
dat_table$total_area_100_sq_mile = dat_table$total_area/259000000
dat_table$total_area_sq_mile = dat_table$total_area/2590000

counties_geo$total_area_sq_mile = counties_geo$ALAND/2590000
```

### Load prediction dataset

```{r}
pred_ehe_1 =read.csv("~/Desktop/EHE_Pred_freq_dat/frequency_pred_EHE_last_15years.csv")
pred_ehe_2 = read.csv("~/Desktop/EHE_Pred_freq_dat/lstm_pred_freq_last_15years.csv")
...
```{r}
hist(best_models_df$event_count_2025)
table(best_models_df$method)
```
